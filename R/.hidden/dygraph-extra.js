// Wrapper: wait until Dygraph is loaded before executing the rest.
(function () {
    ...
    function init() {
        if (typeof Dygraph === 'undefined') {
            if (waited >= MAX_WAIT_MS) {
                throw new Error("Dygraph not found after waiting; please include dygraph.js before dygraph-extra.js.");
            }
